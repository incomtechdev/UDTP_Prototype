...
static const char qt_meta_stringdata_UI[] = {
    "UI\0\0item\0changeDirFromFileSystem(QTableWidgetItem*)\0"
    "index\0ChangeLeftDrive(int)\0"
    "ChangeRightDrive(int)\0"
};
...
int UI::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: changeDirFromFileSystem((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 1: ChangeLeftDrive((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: ChangeRightDrive((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
