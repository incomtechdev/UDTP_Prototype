...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FTPServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FTPServer_t qt_meta_stringdata_FTPServer = {
    {
QT_MOC_LITERAL(0, 0, 9), // "FTPServer"
QT_MOC_LITERAL(1, 10, 8), // "writeLog"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "message"
QT_MOC_LITERAL(4, 28, 18), // "setFTPServerStatus"
QT_MOC_LITERAL(5, 47, 6), // "status"
QT_MOC_LITERAL(6, 54, 11) // "AbortServer"

    },
    "FTPServer\0writeLog\0\0message\0"
    "setFTPServerStatus\0status\0AbortServer"
};
...
void FTPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FTPServer *_t = static_cast<FTPServer *>(_o);
        switch (_id) {
        case 0: _t->writeLog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->setFTPServerStatus((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->AbortServer(); break;
        default: ;
        }
        ...
        {
            typedef void (FTPServer::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FTPServer::writeLog)) {
                *result = 0;
            }
        }
        {
            typedef void (FTPServer::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FTPServer::setFTPServerStatus)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FTPServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FTPServer.data,
      qt_meta_data_FTPServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FTPServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FTPServer.stringdata))
