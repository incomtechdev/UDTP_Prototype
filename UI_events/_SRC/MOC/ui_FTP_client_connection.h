...
public:
    ...
    void setupUi(QDialog *FTP_connect_Dialog)
    {
        ...
        loginpass_radioButton->setObjectName(QString::fromUtf8("loginpass_radioButton"));
        loginpass_radioButton->setGeometry(QRect(20, 10, 121, 18));
        authID_radioButton = new QRadioButton(frame_2);
        authID_radioButton->setObjectName(QString::fromUtf8("authID_radioButton"));
    ...
    void retranslateUi(QDialog *FTP_connect_Dialog)
    {
        ...
        loginpass_radioButton->setText(QApplication::translate("FTP_connect_Dialog", "Login/Password used", 0, QApplication::UnicodeUTF8));
        authID_radioButton->setText(QApplication::translate("FTP_connect_Dialog", "Authendificator used", 0, QApplication::UnicodeUTF8));
